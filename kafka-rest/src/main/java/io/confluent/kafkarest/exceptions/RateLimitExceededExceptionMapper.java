...
public final class RateLimitExceededExceptionMapper
    implements ExceptionMapper<RateLimitExceededException> {

  @Override
  public Response toResponse(RateLimitExceededException exception) {
    final ErrorMessage message = new ErrorMessage(exception.getErrorCode(), exception.getMessage());
    Response.ResponseBuilder responseBuilder =
        Response.status(exception.getStatus()).entity(message);
