...
abstract class AbstractConfigManager<
   ...
   * altered as a result).
   */
  // KREST-8518 A separate overload is provided instead of changing the pre-existing safeAlterConfigs
  // method in order to minimize any risks related to external usage of that method (as this manager
