...
public abstract class ConsumerGroup {
  ...
  /**
   * Encapsulates the GroupState enum to provide a JSON serde form that: - serialize to
   * SCREAMING_SNAKE_CASE of state name - deserialize from SCREAMING_SNAKE_CASE of state name
   */
  public static class State {
    ...
    public static State fromString(String state) {
      return new State(NAME_TO_ENUM.get(state.toUpperCase(Locale.ROOT)));
    }
  }
}
