...
public final class UpdateBrokerConfigRequest {
  ...
  @JsonCreator
  public UpdateBrokerConfigRequest(@JsonProperty("data") @Nullable Data data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateBrokerConfigRequest that = (UpdateBrokerConfigRequest) o;
  ...
  public String toString() {
    return new StringJoiner(", ",
        UpdateBrokerConfigRequest.class.getSimpleName() + "[", "]")
        .add("data=" + data)
        .toString();
  }
  ...
  public static final class Data {
    ...
    @Override
    public String toString() {
      return new StringJoiner(", ", UpdateBrokerConfigRequest.Data.class.getSimpleName() + "[", "]")
