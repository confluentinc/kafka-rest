...
public final class AvroConsumerRecord {
  ...
  public static AvroConsumerRecord fromConsumerRecord(ConsumerRecord<JsonNode, JsonNode> record) {
  ...
  public boolean equals(Object o) {
    ...
    AvroConsumerRecord that = (AvroConsumerRecord) o;
  ...
  public String toString() {
    return new StringJoiner(", ", AvroConsumerRecord.class.getSimpleName() + "[", "]")
        .add("topic='" + topic + "'")
        .add("key=" + key)
        .add("value=" + value)
