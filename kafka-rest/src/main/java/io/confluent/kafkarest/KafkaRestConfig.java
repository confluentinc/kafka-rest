...
public class KafkaRestConfig extends RestConfig {
  ...
  private static final String HOST_PORT_DOC =
      "The host port used to generate absolute URLs in responses. If empty, the requesters url"
          + " port is used";
  public static final Integer HOST_PORT_DEFAULT = 0;
  ...
  protected static ConfigDef baseKafkaRestConfigDef() {
    return baseConfigDef()
        ...
        .define(HOST_PORT_CONFIG, Type.INT, HOST_PORT_DEFAULT, Importance.MEDIUM, HOST_PORT_DOC)
        .define(
