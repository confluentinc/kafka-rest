...
/**
 * This class is a Jetty DosFilter.Listener, for the per-tenant-dos filter. This on 429s will
 * populate relevant metadata as attributes on the request, that later-on can be logged.
 */
public class TenantDosFilterListener extends DoSFilter.Listener {
