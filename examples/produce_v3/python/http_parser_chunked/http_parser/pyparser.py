# -*- coding: utf-8 -
#
# Taken as it is from https://github.com/benoitc/http-parser/blob/d6ce4b5c58e68d5cf3be0676d9b97c3bd9ca88df/http_parser/pyparser.py#LL1C1-L1C1
...
from http_parser_chunked.http_parser.util import (b, bytes_to_str, IOrderedDict, StringIO,
        unquote, MAXSIZE)
...
class InvalidUse(Exception):
    """ error raised when the parser is used incorrectly """
