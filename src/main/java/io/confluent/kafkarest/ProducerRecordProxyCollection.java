...
/**
 * Implementation of Iterable<ProducerRecord> that just wraps an underlying collection of ProduceRecord entities.
 */
public class ProducerRecordProxyCollection implements Iterable<ProducerRecord> {
    ...
    public ProducerRecordProxyCollection(String topic, int partition, Collection<ProduceRecord> records) {
        this.topic = topic;
