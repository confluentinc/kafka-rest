...
public class MockKafkaConsumer implements Consumer<byte[], byte[]> {
  ...
  @Override
  public void subscribe(List<String> topics, ConsumerRebalanceListener consumerRebalanceListener) {
    if (assignment == null) {
      if (subscription == null) {
        subscription = topics;
      }
  ...
  @Override
  public void seekToBeginning(TopicPartition... topicPartitions) {
    throw new AssertionError("Not implemented");
  }

  @Override
  public void seekToEnd(TopicPartition... topicPartitions) {
    throw new AssertionError("Not implemented");
  }
