...
import {getConsumer, listClusters, listConsumerGroups, listConsumers} from './common.js'
...
export default function (data) {
    ...
    getConsumer(data.clusterId, consumer.consumerGroupId, consumer.consumerId);
}
