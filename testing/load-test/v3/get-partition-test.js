...
import {createTopic, deleteTopic, getPartition, listClusters, listPartitions} from './common.js';
...
export default function (data) {
    ...
    getPartition(data.clusterId, partition.topicName, partition.partitionId);
}
