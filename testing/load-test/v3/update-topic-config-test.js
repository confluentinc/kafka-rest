...
import {createTopic, deleteTopic, listClusters, updateTopicConfig} from './common.js';
...
export default function (data) {
    updateTopicConfig(data.clusterId, randomItem(data.topics), 'compression.type', 'gzip');
