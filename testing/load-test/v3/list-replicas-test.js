...
import {createTopic, deleteTopic, listClusters, listPartitions, listReplicas} from './common.js';
...
export default function (data) {
    ...
    listReplicas(data.clusterId, partition.topicName, partition.partitionId);
}
